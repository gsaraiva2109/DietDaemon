...
## Corpus Check
- 329 files · ~246,732 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3017 nodes · 5242 edges · 82 communities detected
- Extraction: 73% EXTRACTED · 27% INFERRED · 0% AMBIGUOUS · INFERRED: 1441 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (123): AuthConfig, AuthStore, BackupRunner, ChatStore, emailToken, fakeMailer, Handler, clientIP() (+115 more)
...
Cohesion: 0.02
Nodes (88): TestComplete(), TestCompleteHTTPError(), TestEmbedNotSupported(), ExtractSuggestions(), TestExtractSuggestions_BlockNotAtEnd(), TestExtractSuggestions_EmptyArray(), TestExtractSuggestions_IntArray(), TestExtractSuggestions_MalformedJSON() (+80 more)
...
Cohesion: 0.03
Nodes (66): MFAChallengeRepo, GenerateSecret(), contains(), TestGenerateSecret(), TestGenerateSecretEmptyAccount(), TestGenerateSecretEmptyIssuer(), TestValidateCode(), TestValidateCodeEmptySecret() (+58 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (34): CorrectCommand, CorrectResolver, CorrectStore, MealStore, NewProfileCommand(), ProfileCommand, ProfileStore, NewTargetCommand() (+26 more)
...
Cohesion: 0.07
Nodes (30): Embedder, fakeSource, fakeStore, fingerprintStore, localFingerprint(), New(), NewWithLocalPaths(), replaceDataset() (+22 more)
...
Cohesion: 0.16
Nodes (30): Config, decodeKey(), getBool(), getDuration(), getFloat(), getInt(), getStr(), hostFromBaseURL() (+22 more)
...
- **Thin community `Community 60`** (6 nodes): `WebAuthnUser`, `.WebAuthnCredentials()`, `.WebAuthnDisplayName()`, `.WebAuthnIcon()`, `.WebAuthnID()`, `.WebAuthnName()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (6 nodes): `fakeStore`, `.FrequentFoods()`, `.GetFood()`, `.GetFoodDetail()`, `.GetRollup()`, `.GetTargets()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `New()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 11`, `Community 12`, `Community 13`, `Community 19`, `Community 24`, `Community 25`, `Community 26`?**
  _High betweenness centrality (0.357) - this node is a cross-community bridge._
- **Why does `run()` connect `Community 1` to `Community 0`, `Community 3`, `Community 4`, `Community 6`, `Community 11`, `Community 13`, `Community 15`, `Community 19`, `Community 23`, `Community 34`, `Community 38`, `Community 44`, `Community 45`, `Community 46`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 54`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `Store` connect `Community 2` to `Community 0`, `Community 1`, `Community 9`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Are the 226 inferred relationships involving `New()` (e.g. with `run()` and `buildEmbedAdapter()`) actually correct?**
  _`New()` has 226 INFERRED edges - model-reasoned connections that need verification._
