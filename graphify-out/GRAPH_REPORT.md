# Graph Report - DietDaemon  (2026-07-06)

## Corpus Check
- 266 files · ~173,294 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2226 nodes · 4035 edges · 72 communities detected
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 930 edges (avg confidence: 0.8)
...
Cohesion: 0.03
Nodes (76): AuthConfig, AuthStore, BackupRunner, Handler, clientIP(), isSixDigit(), readSessionCookie(), bearerToken() (+68 more)
...
Cohesion: 0.02
Nodes (127): newFakeStore(), TestRunFor_MissingDestinationErrors(), TestRunOnce_IgnoresIntervalGate(), TestTick_RunsWhenIntervalElapsed(), TestTick_SkipsDisabledOrUnconfigured(), TestTick_SkipsWhenNotYetDue(), fakeDest, fakeStore (+119 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (78): NewCorrectCommand(), TestCorrectCommand_BadGramsFormat(), TestCorrectCommand_HappyPath(), TestCorrectCommand_NoRecentMeal(), fakeCmd, fakeCorrectResolver, fakeCorrectStore, fakeNudgeStore (+70 more)
...
Cohesion: 0.09
Nodes (81): fakeMealLogger, decodeJSON(), doRequest(), newFakeAuthStore(), newFakeMealStore(), newHandler(), TestAddAlias(), TestAddAliasMissing() (+73 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (62): buildNudgeRuleView(), buildNudgeRuleViewWeeklyBudget(), DigestRule, fakeChatRouteStore, fakeChatSender, fakeDigestStore, fakeFullStore, fakeHealthStore (+54 more)
...
Cohesion: 0.05
Nodes (26): emailTestAuthStore, emailToken, fakeMailer, buildEmailHandler(), newEmailTestAuthStore(), TestEmailVerifyExpiredToken(), TestEmailVerifyInvalidToken(), TestEmailVerifyPurposeMismatch() (+18 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (48): APIKey, AuditEvent, BackupConfig, BodyCompositionSummary, DailyRollup, DailyTargets, Fast, FoodAlias (+40 more)
...
Cohesion: 0.09
Nodes (33): macrosSum(), TemplateCommand, TemplateComposer, TemplateMealLogger, TemplateStore, Config, decodeKey(), getBool() (+25 more)
...
Cohesion: 0.13
Nodes (12): Adapter, callbackQuery, getUpdatesResponse, sendMessageRequest, sendMessageResponse, New(), tgChat, tgInlineKeyboardButton (+4 more)
...
## Knowledge Gaps
- **219 isolated node(s):** `phraseEntry`, `RecoveryCodeRepo`, `TOTPRepo`, `MFAChallengeRepo`, `LoginAttemptRepo` (+214 more)
...
- **Thin community `Community 52`** (7 nodes): `NewStartCommand()`, `StartCommand`, `.Aliases()`, `.Handle()`, `.Help()`, `.Name()`, `start.go`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (7 nodes): `Registry`, `.Dispatch()`, `.List()`, `.Register()`, `registry.go`, `onSubmit()`, `Register.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (6 nodes): `WebAuthnUser`, `.WebAuthnCredentials()`, `.WebAuthnDisplayName()`, `.WebAuthnIcon()`, `.WebAuthnID()`, `.WebAuthnName()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 57`** (6 nodes): `HelpCommand`, `.Aliases()`, `.Handle()`, `.Help()`, `.Name()`, `help.go`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (6 nodes): `New()`, `Matcher`, `.EmbedFood()`, `.Match()`, `.SetThreshold()`, `embedding.go`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (5 nodes): `whisper.go`, `inferenceResponse`, `Provider`, `.Transcribe()`, `New()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (4 nodes): `queue.go`, `Memory`, `Queue`, `NewMemory()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (4 nodes): `s3dest.go`, `Dest`, `.Write()`, `New()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 79`** (3 nodes): `dayKey()`, `relativeDayLabel()`, `History.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `New()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 9`, `Community 10`, `Community 14`, `Community 19`, `Community 20`?**
  _High betweenness centrality (0.194) - this node is a cross-community bridge._
- **Why does `run()` connect `Community 3` to `Community 0`, `Community 2`, `Community 36`, `Community 6`, `Community 7`, `Community 10`, `Community 44`, `Community 45`, `Community 46`, `Community 14`, `Community 47`, `Community 16`, `Community 19`, `Community 52`, `Community 30`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `Handler` connect `Community 0` to `Community 27`, `Community 3`, `Community 6`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Are the 149 inferred relationships involving `New()` (e.g. with `run()` and `buildModelAndIndex()`) actually correct?**
  _`New()` has 149 INFERRED edges - model-reasoned connections that need verification._
