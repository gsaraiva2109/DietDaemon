...
## Corpus Check
- 497 files · ~686,444 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5482 nodes · 12622 edges · 72 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 4830 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (512): accountRepos, TestBYOKKeyAbsenceRetainsSharedAdapterFallback(), fakeSuggester, deleteAccountTestHandler(), newHandlerWithAccountStore(), TestHandleDeleteAccountClearsSessionCookie(), TestHandleDeleteAccountEmailSendFailureStillSucceeds(), TestHandleDeleteAccountEmailSkippedOnUserLookupFailure() (+504 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (128): chatStreamState, credCreateConfig, credRevokeConfig, customFoodRequest, dayOverrideBody, deleteAccountRequest, ErrorCode, errorEnvelope (+120 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (298): TestAuthenticatedRateLimitCategories(), TestAuthenticatedRateLimitReturnsStructuredError(), assertDoneEvent(), assertTextDeltaEvent(), assertToolCallEvent(), assertToolResultEvent(), collectEvents(), TestRouterContextCancellation() (+290 more)
...
Cohesion: 0.02
Nodes (201): TestComplete(), TestCompleteHTTPError(), TestEmbedNotSupported(), checkExtractMenuRequest(), checkExtractPlanRequest(), TestExtractLabel(), TestExtractLabelHTTPError(), TestExtractMenu() (+193 more)
...
Cohesion: 0.02
Nodes (141): Adapter, contentBlock, message, messagesRequest, messagesResponse, writeCSV(), capturingDest, Destination (+133 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (129): AccountStore, APIKeyStore, AuditStore, AuthConfig, AuthRepos, AuthStore, BackupRunner, ChatStore (+121 more)
...
Cohesion: 0.02
Nodes (90): Stat(), Config, addProblem(), parseProxyEntry(), validateBulkFile(), Embedder, fingerprintStore, localFingerprint() (+82 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (63): classifyGoalDivergence(), NewWebAuthnHandle(), TestNewWebAuthnHandle(), cors(), corsOriginAllowed(), limitRequestBody(), newHTTPHandler(), newHTTPServer() (+55 more)
...
Cohesion: 0.03
Nodes (48): CorrectCommand, CorrectResolver, CorrectStore, fakeMealStore, MealStore, parsePositiveFloat(), setProfileField(), ProfileCommand (+40 more)
...
Cohesion: 0.05
Nodes (44): fakeCompletionAdapter, assertDietboxDraft(), derefOrNilStr(), itemCount(), mustReadFixture(), TestHandleExtractPlanFromImage_MultiPageFixtureRegression(), TestHandleExtractPlanFromText_MultiPageFixtureRegression(), TestHandleExtractPlanFromText_OutOfOrderMarkersPassthrough() (+36 more)
...
Cohesion: 0.07
Nodes (17): formatDurationShort(), NewFastCommand(), FastCommand, FastStore, randomID(), calcSleepHours(), computeSleepDuration(), formatDuration() (+9 more)
...
Cohesion: 0.11
Nodes (18): fakePlanStore, findSlotByLabel(), NewPlanCommand(), nextSlotID(), optionSummary(), parseTimeOfDay(), slotsForDayType(), bundleWithSlots() (+10 more)
...
Cohesion: 0.07
Nodes (17): Client, NewClient(), listResponse, Config, Mailer, New(), smtpPortOrDefault(), Message (+9 more)
...
## Knowledge Gaps
- **362 isolated node(s):** `appRuntime`, `phraseEntry`, `bulkUpserter`, `mealSaver`, `Row` (+357 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 31`** (31 nodes): `allEntitiesFakeStore`, `.GetMealsInRange()`, `.GetPhotosData()`, `.GetRollups()`, `.GetWaterInRange()`, `.GetWorkoutsInRangeWithExercises()`, `.ListFasts()`, `.ListMeasurements()`, `.ListPhotoMetadata()`, `.ListSleep()`, `.ListWeight()`, `fakeStore`, `.AccountDeletedAt()`, `.GetBackupConfig()`, `.GetMealsInRange()`, `.GetPhotosData()`, `.GetPlanBundle()`, `.GetRollups()`, `.GetWaterInRange()`, `.GetWorkoutsInRangeWithExercises()`, `.ListDayOverrides()`, `.ListFasts()`, `.ListMeasurements()`, `.ListPhotoMetadata()`, `.ListPlans()`, `.ListSleep()`, `.ListTemplatesForBackup()`, `.ListUsers()`, `.ListWeight()`, `.SetBackupCounts()`, `.SetBackupLastRun()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (12 nodes): `fakeStore`, `.GetRollup()`, `.GetTargets()`, `.GetUser()`, `.GetUserIDByChannel()`, `.MapChannelUser()`, `.SaveMeal()`, `.SetTargets()`, `.TargetsFor()`, `.UpsertChatRoute()`, `.UpsertRollup()`, `.UpsertUser()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (8 nodes): `pendingstore.go`, `New()`, `Store`, `.Delete()`, `.deleteRow()`, `.expired()`, `.Get()`, `.Save()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `New()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `Community 17`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 26`, `Community 27`, `Community 34`, `Community 35`, `Community 36`, `Community 45`?**
  _High betweenness centrality (0.393) - this node is a cross-community bridge._
- **Why does `newHandler()` connect `Community 0` to `Community 2`, `Community 36`, `Community 13`, `Community 45`, `Community 20`, `Community 21`, `Community 22`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `contains()` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 7`, `Community 8`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 23`, `Community 29`, `Community 30`, `Community 34`, `Community 35`?**
...
- **Are the 538 inferred relationships involving `New()` (e.g. with `TestRunReturnsConfigLoadError()` and `adminTempStore()`) actually correct?**
  _`New()` has 538 INFERRED edges - model-reasoned connections that need verification._
