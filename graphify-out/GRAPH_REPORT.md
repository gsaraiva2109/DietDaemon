# Graph Report - DietDaemon  (2026-07-14)

## Corpus Check
- 319 files · ~238,021 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2940 nodes · 5089 edges · 82 communities detected
- Extraction: 73% EXTRACTED · 27% INFERRED · 0% AMBIGUOUS · INFERRED: 1393 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (98): AuthConfig, AuthStore, BackupRunner, ChatStore, emailToken, fakeMailer, Handler, clientIP() (+90 more)
...
Cohesion: 0.02
Nodes (193): collectEvents(), TestRouterContextCancellation(), TestRouterErrorPropagation(), TestRouterMidStreamError(), TestRouterSeedsHistory(), TestRouterTextOnly(), TestRouterTextOnly_doneForwarded(), TestRouterToolCallMaxRounds() (+185 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (94): TestComplete(), TestCompleteHTTPError(), TestEmbedNotSupported(), ExtractSuggestions(), TestExtractSuggestions_BlockNotAtEnd(), TestExtractSuggestions_EmptyArray(), TestExtractSuggestions_IntArray(), TestExtractSuggestions_MalformedJSON() (+86 more)
...
Cohesion: 0.05
Nodes (38): MFAChallengeRepo, GenerateSecret(), contains(), TestGenerateSecret(), TestGenerateSecretEmptyAccount(), TestGenerateSecretEmptyIssuer(), TestValidateCode(), TestValidateCodeEmptySecret() (+30 more)
...
Cohesion: 0.08
Nodes (25): bulkUpserter, main(), run(), runBackfill(), runImport(), tempStore(), TestRunImport_DryRunWritesNothing(), TestRunImport_TACO() (+17 more)
...
## Knowledge Gaps
- **317 isolated node(s):** `phraseEntry`, `bulkUpserter`, `HevyWorkout`, `HevyExercise`, `HevySet` (+312 more)
...
- **Thin community `Community 60`** (6 nodes): `WebAuthnUser`, `.WebAuthnCredentials()`, `.WebAuthnDisplayName()`, `.WebAuthnIcon()`, `.WebAuthnID()`, `.WebAuthnName()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 64`** (5 nodes): `fakeCommand`, `.Aliases()`, `.Handle()`, `.Help()`, `.Name()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `New()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 16`, `Community 21`, `Community 22`, `Community 24`, `Community 25`, `Community 26`?**
  _High betweenness centrality (0.262) - this node is a cross-community bridge._
- **Why does `run()` connect `Community 2` to `Community 0`, `Community 3`, `Community 4`, `Community 10`, `Community 12`, `Community 14`, `Community 16`, `Community 21`, `Community 23`, `Community 28`, `Community 33`, `Community 37`, `Community 43`, `Community 44`, `Community 45`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 54`?**
  _High betweenness centrality (0.139) - this node is a cross-community bridge._
- **Why does `Store` connect `Community 1` to `Community 0`, `Community 2`, `Community 6`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Are the 219 inferred relationships involving `New()` (e.g. with `run()` and `buildEmbedAdapter()`) actually correct?**
  _`New()` has 219 INFERRED edges - model-reasoned connections that need verification._
